...
public:
	...
	using CloseRequestCallback = std::function<void(NewRequestPtr)>;
	using HandleRequestCallback = std::function<void(NewRequestPtr)>;
	using HandleResponseCallback = std::function<void(NewRequestPtr)>;
